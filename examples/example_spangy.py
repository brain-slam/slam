...
mesh = sio.load_mesh(
    '../spangy/Data/mar0003_recons_nobias_cortex_smooth_hemil.bouchee.gii')
...
grouped_spectrum, group_indices, coefficients = spgy.spectrum(mean_curv, lap_b,
                                                              eigVects, eigVal)
...
print('Volume = %d mL, Area = %d cm^2, Analyze Folding Power = %f,' %
