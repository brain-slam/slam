...
if __name__ == '__main__':
    ...
    sphere_random = sgps.generate_sphere_random_sampling(vertex_number=sphere_regular.vertices.shape[0], radius=4)
    # compare their volume to the analytical one
    analytical_vol = (4/3)*np.pi*np.power(4, 3)
    print('volume error for regular sampling: {:.3f}'.format(sphere_regular.volume-analytical_vol))
